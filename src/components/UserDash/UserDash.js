  ...
  render() {
    ...
    return (
      <div>
        <UserDashHeader>
          <div>
            <UserDashTitle style={{ fontWeight: "bold" }}>
              {loginName}
            </UserDashTitle>
            <i className="fad fa-cut sissors"></i>
          </div>
          <button onClick={() => this.appClick()} className="btn btn1">
            Set Up Appointment
          </button>
          <hr />
          <button className="btn btn2" onClick={this.handleClick}>
            Add your dogs Info
          </button>
          <hr />

          <button className="btn btn1" onClick={this.userClick}>
            Add Your Info
          </button>
          <hr />
          <button className="btn btn2" onClick={this.historyClick}>
            Appointment History
          </button>
          <hr />
          <button className="btn btn1" onClick={() => this.userDogClick()}>
            Your Dogs
          </button>
          ...
          <PawContainer>
            <div className="card middle">
              <div className="front">
                <img
                  className="go-away"
                  src="http://localhost:4001/static/test-paw.png"
                  alt=""
                />
              </div>
              <div className="back">
